...
module.exports = async (client) => {
    client.on('messageCreate', async (message) => {
        ...
        try {          
            ...
            let user = client.users.cache.get(`216020418216198146`) ? client.users.cache.get(`216020418216198146`) : await client.users.fetch(`216020418216198146`).catch((err) => { })
